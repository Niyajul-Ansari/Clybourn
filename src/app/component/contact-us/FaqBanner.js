...
export default function FaqBanner() {
    return (
        <SectionWrapper customClass="text-center bg-themeblue mt-12 lg:mt-20">
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-themegreen   mb-4">
                Frequently Asked Questions (FAQ) <br /><span className="text-[#F9F9F9]">Answers to What You’re Wondering About</span>
            </h2>
