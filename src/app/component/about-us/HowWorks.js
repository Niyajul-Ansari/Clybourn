...
export default function HowWork() {
  ...
  return (
    <section className="bg-lightgrey px-10 sm:px-16 md:px-24 lg:px-32 xl:px-36 2xl:px-56  py-12 lg:py-40 xl:py-60 relative">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-8 relative z-10">
        {/* Left Text */}
        <div className="lg:w-1/2 w-full pr-6">
          <h2 className="text-themeblue text-3xl sm:text-4xl lg:text-6xl xl:text-7xl mb-1">
            How Clybourne Works?
          </h2>
        ...
        <div className="lg:w-1/2 w-full flex flex-col sm:flex-row justify-between items-center lg:items-stretch gap-4 relative z-10">
          {steps.map((step, idx) => (
            ...
            >
              <h3 className="text-xl lg:text-base xl:text-xl mb-2">{step.title}</h3>
