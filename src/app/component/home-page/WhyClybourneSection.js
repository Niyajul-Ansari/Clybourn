...
const features = [
  ...
  },
  {
    ...
    description: 'Premium reports at 1/10th the cost.',
  },
  {
    title: 'Global & Secure',
...
export const WhyClybourneSection = () => {
  return (
    <section className="px-10 sm:px-16 md:px-24 lg:px-32 xl:px-36 2xl:px-56  py-10 bg-lightgrey">
      <div className="w-full mx-auto grid md:grid-cols-2 gap-4 xl:gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-themeblack md:text-lg text-sm">
            Why businesses choose us over competitors like Equidam.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 ">
          ...
          <div className="flex flex-col gap-6 mt-10">
            {[features[1], features[3]].map((feature, index) => (
              ...
              >
                <div className="w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9 bg-themeblue text-themegreen flex items-center justify-center rounded">
                  <ArrowUpRightIcon />
                </div>
