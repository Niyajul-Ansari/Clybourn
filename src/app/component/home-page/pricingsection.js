...
export const PricingSection = () => {
  const pricingPlans = [
    {
      title: 'Clybourne’s Online Valuation Tool',
      price: '$109 (Save 90%)',
    },
    {
      title: 'Traditional Valuation Cost',
      price: '$10,000+',
    }
  ];
      ...
      <SectionWrapper customClass="bg-white">
        <div className="w-full mx-auto flex flex-col md:flex-row justify-between gap-16">
          ...
          <div className="flex-1">
            ...
            <a href="#" className="text-[lightblue] text-sm underline hover:text-themegreen">
              Write to us
            </a>
          </div>
          ...
          <div className="flex-1 w-full flex flex-col sm:flex-row justify-center items-stretch gap-2 px-2">
            ...
            >
              <div className='flex flex-col items-center'>
                ...
                <p className=" text-2xl mb-8 text-white">$109 <br/>(Save 90%)</p>
              </div>
